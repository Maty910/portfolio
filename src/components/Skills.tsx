import { 
  ...
  SiGit, SiTailwindcss, SiJson, SiNetlify, SiGithub, SiFigma, SiDocker, SiCanva, SiSolidity
} from 'react-icons/si';
      ...
      <div className="w-full max-w-[1000px] px-6 md:px-12 py-12 mx-auto flex flex-col justify-center h-full
        ...
        */}
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
          ...
          {/* Soft Skills Card */}
          <div className="flex-1 p-6 rounded-2xl bg-text-primary/5 border border-text-primary/10 
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {SOFT_SKILLS.map((skill) => (
                ...
                >
                  <skill.icon size={20} className={`${skill.color} group-hover/soft:scale-110 transition-transform duration-300`} />
          ...
          <div className="lg:w-[340px] p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent 
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <Terminal size={16} className="relative z-20 group-hover/link:translate-x-1 transition-transform duration-300" />
              </a>
            </div>
          </div>
