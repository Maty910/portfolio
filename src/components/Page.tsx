...
export function Page({ children, activeSection = "home" }: PageProps) {
  ...
  return (
    <div className="page w-full min-h-screen bg-bg-base text-text-primary overflow-x-hidden selection:bg-primary/30 selection:text-primary relative transition-colors duration-500">
