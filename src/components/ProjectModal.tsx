import { ChevronLeft, ChevronRight, Code2, ExternalLink, Github, X } from "lucide-react";
...
export const ProjectModal: React.FC<Props> = ({ project, onClose }) => {
  ...
  const images = project
    ? Array.isArray(project.image)
      ? project.image.filter((img) => img != null)
      : [project.image].filter((img) => img != null)
    : [];
  ...
  }, [project, onClose, images.length, nextImage, prevImage]); // Agregamos dependencias
